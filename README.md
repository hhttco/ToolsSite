...
🌐 **生产环境示范域名**：[https://tool.898989.top](https://tool.898989.top)  
...
python3 -m venv tool_env && source tool_env/bin/activate && pip install --upgrade pip && pip install Flask Pillow gunicorn pdf2docx pdfplumber openpyxl pypdf qrcode opencv-python-headless numpy  PyMuPDF<=1.26.4
```
